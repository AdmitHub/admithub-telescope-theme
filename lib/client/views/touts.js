...
Template[getTemplate('ah_touts')].helpers({
  ...
  showTouts: function() {
    ...
    var newsletterTemplate = Template[getTemplate("newsletterBanner")];
    var showBannerHelper = newsletterTemplate && newsletterTemplate.__helpers[" showBanner"];
    if (showBannerHelper && showBannerHelper()) {
      return false;
    }
    return true;
  },
