...
primaryNav = ['notificationsMenu', 'topQuestions', 'userMenu', 'adminMenu', 'ah_search'];
secondaryNav = [];
...
Meteor.startup(function() {
  ...
  Avatar.options.defaultAvatarUrl = ahAssetPath + "img/owlAvatar.png";
  if (Meteor.isServer) {
    Avatar.options.serverBaseUrl = process.env.ROOT_URL;
  } else {
    Avatar.options.serverBaseUrl = window.location.protocol + "//" + window.location.host;
  }
  ...
  Meteor.startup(function() {
    ...
    Router.map(function() {
      this.route("contributors", {
        path: "/partners-and-contributors",
