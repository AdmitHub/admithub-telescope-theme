FreeTrialBotSchema = new SimpleSchema({
  ...
  "activitiesAwards.local": {type: Boolean, optional: true, label: "Local award"},
  "activitiesAwards.regional": {type: Boolean, optional: true, label: "Regional award"},
  "activitiesAwards.national": {type: Boolean, optional: true, label: "National award"},
  "activitiesAwards.international": {type: Boolean, optional: true, label: "International award"},
  ...
  "weather.flipFlops": {type: Boolean, optional: true, label: "I prefer shorts and flip-flops all the time"},
  "weather.allSeasons": {type: Boolean, optional: true, label: "I want all the seasons"},
  "weather.frozenTundra": {type: Boolean, optional: true, label: "A frozen tundra"},
  ...
  "city.big": {type: Boolean, optional: true, label: "In a big city"},
  "city.medium": {type: Boolean, optional: true, label: "In a mid-sized city or town"},
  "city.small": {type: Boolean, optional: true, label: "In a small town"},
  "city.sticks": {type: Boolean, optional: true, label: "In the sticks"},
  "city.irrelevant": {type: Boolean, optional: true, label: "It doesn't matter"},

  "region": {type: Object, optional: true},
  "region.northeast": {type: Boolean, optional: true, label: "Northeastern US"},
  "region.southeast": {type: Boolean, optional: true, label: "Southeastern US"},
  "region.southwest": {type: Boolean, optional: true, label: "Southwestern US"},
  "region.midwest": {type: Boolean, optional: true, label: "Midwestern US"},
  "region.west": {type: Boolean, optional: true, label: "Western US"},
  "region.any": {type: Boolean, optional: true, label: "Anywhere"},
  ...
  "utm_medium": {type: String, optional: true}
});
